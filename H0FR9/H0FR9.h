/*
 ...
 Module: Relay control with CLI communication.
 Ports: CLI interface for command processing.
 Peripherals: GPIO for relay control (single pin).
 Enums: Relay states (NO/NC) and module-specific error codes.
...
/* Relay State Enum Definition */
typedef enum {
    RELAY_STATE_NO = 0,  /* Normally Open (NO) connected */
    RELAY_STATE_NC       /* Normally Closed (NC) connected */
} Relay_State;
